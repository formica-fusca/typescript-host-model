---
title: The answers
description: All six questions settled, with the compiler output that settles them.
sidebar:
  order: 1
---

:::caution[Work the exercise first]
These explanations are worth much less if you have not yet been surprised by one of the results.
:::
